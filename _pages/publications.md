...
<img src="{{ '/files/apsk-isac.png' | relative_url }}" alt="APSK constellations for ISAC" style="max-width: 700px; width: 100%; border-radius: 8px; margin: 0.5rem 0 1rem 0;">
...
<img src="{{ '/files/isit-rate-region.png' | relative_url }}" alt="Rate region of discrete signaling for Gaussian broadcast channel" style="max-width: 700px; width: 100%; border-radius: 8px; margin: 0.5rem 0 1rem 0;">
...
<img src="{{ '/files/timing-reliability.png' | relative_url }}" alt="Aging-aware timing reliability prediction" style="max-width: 700px; width: 100%; border-radius: 8px; margin: 0.5rem 0 1rem 0;">

* Authors: F. Hu, S. J. Babu, **Y. Shao**, J. Liu, Y. Pan, S. Singhal, and X. Guo
* Venue: IEEE Transactions on Reliability (under review)
